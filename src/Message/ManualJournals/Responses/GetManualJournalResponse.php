...
namespace PHPAccounting\MyobAccountRight\Message\ManualJournals\Responses;
    ...
    private function parseJournalItems($data, $journal) {
        if ($data) {
            ...
            foreach($data as $journalItem) {
                ...
                $newJournalItem['credit'] = IndexSanityCheckHelper::indexSanityCheck('IsCredit', $journalItem);
